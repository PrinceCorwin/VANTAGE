...
- **Dev/build/tooling workflow** (Codex settings, permission allowlists, repo conventions for tooling, build/release procedures used by humans). Those go in the (TBD) workflow doc tracked under "Documentation Backlog" in `Plans/Project_Status.md`.
...
- Auto-generate a clear, concise commit message summarizing the session's work
  - Do NOT include "Generated with Codex" or "Co-Authored-By: Codex"
