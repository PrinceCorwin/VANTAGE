    ...
    public class ProgressViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<Activity> Activities
        {
            ...
            set
            {
                ...
                // Create collection view for filtering/sorting
        ...
        /// <summary>
        /// Filtered/sorted view of activities
        /// </summary>
        ...
        public void LoadActivities()
        {
            try
            {
                System.Diagnostics.Debug.WriteLine("→ Loading activities from database...");
                ...
                while (reader.Read())
                {
                    var activity = new Activity
                    {
                        ...
                        // Calculated (read from DB but will recalculate)
                ...
                System.Diagnostics.Debug.WriteLine($"✓ Loaded {TotalCount} activities");
            }
            catch (Exception ex)
            {
