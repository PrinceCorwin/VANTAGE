...
- **Filter panel slimmed** — width narrowed (60% → 150px), the bottom "Active" filter-chips section removed, "Clear all" relocated to under the row-count and shown only when a filter is active, and the count text shortened to "N data rows" (dropped "shown").
