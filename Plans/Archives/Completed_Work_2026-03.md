# VANTAGE: Milestone - Completed Work (March 2026)
...
- **Previous Batches Rename button:** New Rename button in PreviousBatchesDialog allows renaming takeoff batches. Creates new `InputDialog.xaml/.cs` for simple text input. Updates S3 `metadata.json` with new `batchName`.
